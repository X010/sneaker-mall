...
<script>
    ...
    $().ready(function(){
        ...
        $('.csort').on('keypress',function(event){
            ...
            if(keycode == '13'){
                $.post("<?php echo U('column/csort');?>", { "id": id,"sort_val":sval },function(data){
                    if(data) {
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <a href="<?php echo U('column/column_edit');?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-hover table-bordered">
                                    ...
                                    <tbody>
                                    <?php if(is_array($coll)): foreach($coll as $key=>$vo): ?><tr>
                                            <td class="huodong">
                                                <div align="center">
                                                    <input type="checkbox" data-id="<?php echo ($vo["id"]); ?>"  data-pub="<?php echo ($vo["publish"]); ?>" <?php if($vo['publish'] == 1): ?>checked="checked"<?php endif; ?> >
                                                </div>
                                            </td>
                                            <td><div align="left"><?php echo ($vo["html"]); echo ($vo["name"]); ?></div></td>
                                            <!--<td><div align="center"><?php echo ($vo["id"]); ?></div></td>-->
                                            <td><div align="center"><input class="csort" type="text" size="3" data-id="<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["csort"]); ?>"></div></td>
                                            <td>
                                                <div align="center">
                                                    <?php if($vo["type"] == 1): ?><span class="">活动栏目</span><?php endif; ?>
                                                    <?php if($vo["type"] == 2): ?><span class="">顶部焦点图</span><?php endif; ?>
                                                </div>
                                            </td>
                                            <td><div align="center"><?php if($vo['wx_home'] == 1): ?>是<?php else: ?>否<?php endif; ?></div></td>
                                            <td><div align="center"><a class="btn btn-primary btn-sm" href="<?php echo U('column/column_edit',array('id'=>$vo['id']));?>" role="button">编辑</a> <a class="btn btn-danger btn-sm del-column" data-id="<?php echo ($vo["id"]); ?>" href="javascript:;">删除</a></div></td>
