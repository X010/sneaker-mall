    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <script>
                $().ready(function(){
                    var tabsli = $('#tabs li');
                    var tabat = ('<?php echo ($_GET['gtyp']); ?>'  == '') ? '1' : '<?php echo ($_GET['gtyp']); ?>' ;
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="pull-right">
                                <form class="" method="post" action="<?php echo U('market/market_list');?>">
                                    <div class="input-group input-group-sm" style="width: 250px;">
                                        <input type="text" name="key" class="form-control pull-right" value="<?php echo ($search_key); ?>" placeholder="请输入赠品栏说明">
                        ...
                        <div class="col-sm-12">
                            <table id="table-price" class="table table-striped table-hover table-bordered" style="margin-bottom:0;">
                                ...
                                <tr >
                                    ...
                                    <th><div align="center">赠品标题</div></th>
                                    <th><div align="center">类型</div> </th>
                                    <th><div align="center">角标</div> </th>
                                    <th><div align="center">范围</div> </th>
                                    <!--<th><div>描述</div> </th>-->
                                </tr>
                                </thead>
                                <tbody>

                                <?php if(is_array($market_list)): foreach($market_list as $key=>$vo): ?><tr class="market_list" data-id="<?php echo ($vo["id"]); ?>" ondblclick="javscript:location.href='<?php echo U('market/gone');?>&id=<?php echo ($vo["id"]); ?>'">
                                        <td><div align="center"><?php echo ($vo["id"]); ?></div> </td>
                                        <td><div align="center"><?php echo ($vo["start_time"]); ?></div> </td>
                                        <td><div align="center"><?php echo ($vo["end_time"]); ?></div> </td>
                                        <td><?php echo ($vo["title"]); ?></td>
                                        <td><div align="center"><?php echo ($vo["mtype"]); ?></div></td>
                                        <td><div align="center"><?php echo ($vo["iconname"]); ?></div></td>
                                        <td><div align="center"><?php echo ($vo["scope"]); ?></div></td>
                                        <!--<td><div><?php echo ($vo["description"]); ?></div></td>-->
